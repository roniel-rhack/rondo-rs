...
const BINDINGS: &[(&str, &str)] = &[
    ...
    ("v  /  V·d  /  V·P", "visual multi-select / bulk done / bulk priority"),
    ...
    (":", "command palette"),
    (".", "quick actions grid"),
    ("s", "sort overlay (default / priority / due / newest / title)"),
    ("p", "toggle pomodoro"),
    ("", ""),
    ("Plugins", ""),
    ("(CLI)", "rondo-tui plugins list / info / install / remove"),
    ("(built-in)", "pomodoro · bell · calendar · focus-page · dep-graph · analytics"),
    ("config", "~/.rondo-rs/config.toml  ·  permissions table gates dangerous caps"),
    ("install dir", "~/.rondo-rs/plugins/<id>/  with plugin.toml + plugin.wasm"),
    ("", ""),
    ("Misc", ""),
    ("?", "toggle this help"),
    ("Esc", "close top modal"),
